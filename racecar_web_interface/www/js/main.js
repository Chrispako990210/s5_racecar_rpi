...
//  function streamVideoCB(message){
//   console.log('Subscribed to video stream');
//   document.getElementById(videoStream).src =image ;
//  }

//  streamVideo = new ROSLIB.Topic({
//     ros : rbServer,
//     name : '/racecar/raspicam_node/image_raw/compressed',
//     messageType : 'sensor_msgs/Image'
//  });

//  streamVideo.subscribe(streamVideoCB)
