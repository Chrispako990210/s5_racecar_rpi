        ...
        function joystickToTwist(speed,angle_in_degrees){
            ...
            if(angle_in_degrees<=90){
                ...
                angle=((angle_in_degrees)/90-1);
                    ...
                    //localStorage.setItem("twist",cmd);
                    // document.getElementById("x").innerText = twist.linear.x;
                    // document.getElementById("y").innerText = twist.linear.y;
                    // document.getElementById("z").innerText = twist.linear.z;
                    // document.getElementById("ax").innerText = twist.angular.x
                    // document.getElementById("ay").innerText = twist.angular.y
                    // document.getElementById("az").innerText = twist.angular.z
                }
